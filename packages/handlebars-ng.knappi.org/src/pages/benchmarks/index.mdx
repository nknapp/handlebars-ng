...
- The numbers in the table are "`mean (± sd)`" where `mean` is the average runtime of the test in milliseconds and `sd` is the standard deviation.
- The charts show the range "`[ mean - sd, mean + sd ]`".
