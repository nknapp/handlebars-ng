...
import empty from './empty.hb-spec.json'
import newline from './newline.hb-spec.json'
import newlineAroundMustache from './newline-around-mustache.hb-spec.json'
...
(i.e. the first character *after* the node.)
...
<Testcase spec={empty} />
<Testcase spec={newline} />
<Testcase spec={newlineAroundMustache} />
